<!-- Navbar -->
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-2 shadow-none border-radius-xl mt-1" id="navbarBlur"
    data-scroll="false">
        ...
        <nav aria-label="breadcrumb" class="">
            <ol class="breadcrumb bg-white mb-0 pb-0 pt-1 px-1 me-sm-6 me-5">
                ...
                <img src="{{ url('/img/logos/logos.png') }}" class="navbar-brand-img h-35" style="height: 35px"
                    alt="main_logo">
                <span class="ms-1 font-weight-bold px-2 py-2">SI-Presensi</span>
            </ol>
