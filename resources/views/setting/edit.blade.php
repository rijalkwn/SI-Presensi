                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            @if (isset($setting->jam_pulang_senin_kamis)) {{ $setting->jam_pulang_senin_kamis }}
                                                    @else @endif">
                                                <label class="form-control-label" for="jam_pulang_senin_kamis">Jam Pulang
                                                    <span class="text-warning">*Hari Senin - Kamis</span></label>
                                                <input type="time" name="jam_pulang_senin_kamis"
                                                    id="jam_pulang_senin_kamis" required
                                                    class="form-control
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            @if (isset($setting->jam_pulang_jumat)) {{ $setting->jam_pulang_jumat }}
                                                    @else @endif">
                                                <label class="form-control-label" for="jam_pulang_jumat">Jam Pulang <span
                                                        class="text-warning">*Hari Jumat</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div
                                        ...
                                        <label class="form-control-label" for="radius">Radius <span
                                                class="text-warning">*satuan meter</span></label>
