                        ...
                        <form action="{{ route('presensi.masuk.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" id="lat_fix" name="lat_fix" value="{{ $setting->lat }}">
                                    <input type="text" id="lng_fix" name="lng_fix" value="{{ $setting->lng }}">
...
@push('javascript')
    ...
    <script>
        ...
        function successCallback(position) {
            ...
            // cek jarak
            if (jarak > radius) {
                alert('Anda tidak berada di lokasi sekolah');
